...
namespace Exe026__Database_ {
    ...
    public partial class DataBaseDataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Code, string Names, string Gender, System.DateTime BirthDate, string Email) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow FindByCode(int Code) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string Names {
                get {
                    try {
                        return ((string)(this[this.tableTable.NamesColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
                        throw new global::System.Data.StrongTypingException("O valor da coluna \'Names\' na tabela \'Table\' é DBNull.", e);
                    }
                }
                set {
                    this[this.tableTable.NamesColumn] = value;
                }
            }
            ...
            public string Gender {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("O valor da coluna \'Gender\' na tabela \'Table\' é DBNull.", e);
                    }
                }
                set {
            ...
            public bool IsNamesNull() {
                return this.IsNull(this.tableTable.NamesColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public void SetNamesNull() {
                this[this.tableTable.NamesColumn] = global::System.Convert.DBNull;
            }
...
namespace Exe026__Database_.DataBaseDataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Table` WHERE ((`Code` = ?) AND ((? = 1 AND `Names` IS NULL) OR (`Nam" +
                "es` = ?)) AND ((? = 1 AND `Gender` IS NULL) OR (`Gender` = ?)) AND ((? = 1 AND `" +
                "BirthDate` IS NULL) OR (`BirthDate` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`" +
                "Email` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Table` (`Code`, `Names`, `Gender`, `BirthDate`, `Email`) VALUES (?, " +
                "?, ?, ?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE `Table` SET `Code` = ?, `Names` = ?, `Gender` = ?, `BirthDate` = ?, `Email` = ? WHERE ((`Code` = ?) AND ((? = 1 AND `Names` IS NULL) OR (`Names` = ?)) AND ((? = 1 AND `Gender` IS NULL) OR (`Gender` = ?)) AND ((? = 1 AND `BirthDate` IS NULL) OR (`BirthDate` = ?)) AND ((? = 1 AND `Email` IS NULL) OR (`Email` = ?)))";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::Exe026__Database_.Properties.Settings.Default.DataBaseConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Code, [Names], Gender, BirthDate, Email FROM [Table]";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT COUNT(*) FROM [Table] Where Gender = \"F\"";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[2] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[2].Connection = this.Connection;
            this._commandCollection[2].CommandText = "SELECT COUNT(*) FROM [Table] Where Gender = \"M\"";
        ...
        public virtual int Delete(int Original_Code, string Original_Names, string Original_Gender, System.DateTime Original_BirthDate, string Original_Email) {
        ...
        public virtual int Insert(int Code, string Names, string Gender, System.DateTime BirthDate, string Email) {
        ...
        public virtual int Update(int Code, string Names, string Gender, System.DateTime BirthDate, string Email, int Original_Code, string Original_Names, string Original_Gender, System.DateTime Original_BirthDate, string Original_Email) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Names, string Gender, System.DateTime BirthDate, string Email, int Original_Code, string Original_Names, string Original_Gender, System.DateTime Original_BirthDate, string Original_Email) {
            return this.Update(Original_Code, Names, Gender, BirthDate, Email, Original_Code, Original_Names, Original_Gender, Original_BirthDate, Original_Email);
        }
        
        [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> CountF() {
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual global::System.Nullable<int> CountM() {
